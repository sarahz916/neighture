...
public class ChosenWaypointsServletTest {
  public static final Coordinate DAISY = new Coordinate(-87.629454, 41.848653, "daisy", "daisy", "iNaturalist.com/daisy");
  public static final Coordinate CLOVER = new Coordinate(-87.635604, 41.855967, "clover", "clover", "iNaturalist.com/clover");
  public static final Coordinate BELLFLOWER = new Coordinate(-87.64748, 41.843539, "bellflower", "bellflower", "iNaturalist.com/bellflower");
  public static final String EXPECTED_MULTIPLE = "[{\"x\":-87.629454,\"y\":41.848653,\"label\":\"daisy\",\"species\":\"daisy\",\"id\":1},"
    + "{\"x\":-87.635604,\"y\":41.855967,\"label\":\"clover\",\"species\":\"clover\",\"id\":4},"
    + "{\"x\":-87.64748,\"y\":41.843539,\"label\":\"bellflower\",\"species\":\"bellflower\",\"id\":3}]\n";
  public static final String EXPECTED_ONE = "[{\"x\":-87.629454,\"y\":41.848653,\"label\":\"daisy\",\"species\":\"daisy\",\"id\":1}]\n";
  ...
  */  
  ...
  public void testOne(){
    ...
    List<Coordinate> actual = servlet.getWaypointsfromRequest(request).getWaypointList();
    List<Coordinate> comparison = new ArrayList<Coordinate>();
